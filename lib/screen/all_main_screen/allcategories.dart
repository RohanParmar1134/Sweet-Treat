...
class Allcategories extends StatelessWidget {
  ...
  allcategoriesviewer(String imagename, String itemname, double size,
    ...
    return Padding(
      ...
      child: Card(
        ...
        child: InkWell(
          ...
          splashColor: Colors.orange[500],
          onTap: () {
            ontapofcategories(context, forquery);
          },
          child: Container(
            height: 220,
            width: 170,
  ...
  ontapofcategories(BuildContext context, String forquery) {
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return Getcategoriesitems(
        itemname: forquery,
      );
    }));
  }
